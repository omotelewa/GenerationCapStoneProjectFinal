...
function addItemCard(item){
    ...
    <td>1</td>
    <td>
      <img src="${item.image}" alt="coockie" height="60px" width="60px" class="cart-img">
    </td>
    <td>Orange</td>
    <td class="price">10</td>
    <td>
      <button type="button" id="${item.id}" class="btn btn-danger">Delete</button>
    </td>
  </tr>
    `;
    const itemsContainer = document.getElementById("table-body");
